...
public class toExcelnoxjServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public toExcelnoxjServlet() {
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		XSSFSheet sheet = workbook.createSheet("未巡检基站统计表");
		//创建sheet
		//创建第一行，标题
		XSSFRow row = sheet.createRow(0);
		String[] cellTitle = {"基站编号","基站名称", "基站等级"};
