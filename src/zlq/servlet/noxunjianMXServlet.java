...
public class noxunjianMXServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Xunjian> xjList = xunjianDao.UnxjSearch(period1, period2,xjName,stationName,level);
    	 
    	if(!xjList.isEmpty()){
    		request.setAttribute("xjList", xjList);
    		request.getRequestDispatcher("noxunjianSearchedResult.jsp").forward(request, response);
