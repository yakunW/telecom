...
public class toExcelycServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public toExcelycServlet() {
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		String[] cellTitle = {"基站编号","基站等级", "基站名称", "巡检人员","异常类型","异常次数","最后一次异常时间","所属表"};
		...
		for(int i=1;i<=ycList.size();i++)
		{
			...
			for (int j = 0; j < cellTitle.length; j++) 
			{
				...
				case 4:
					...
					break;
				case 5:
					dataCell.setCellValue(e.getYcNum());
					break;
				case 6:
