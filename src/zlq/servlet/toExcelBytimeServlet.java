...
public class toExcelBytimeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public toExcelBytimeServlet() {
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		String[] cellTitle = {"基站名称", "基站等级", "该段时间用电量"};
		...
		/*for (int i = 0; i < 30; i++) {
			if(i%2==0){
				eleclist.add(new Emp(i, "zhangsan"+i, "男", "财务部"));
			}else{
				eleclist.add(new Emp(i, "lisi"+i, "女", "行政部"));
			}
		}*/
