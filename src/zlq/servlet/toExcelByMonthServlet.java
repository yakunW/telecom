...
public class toExcelByMonthServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public toExcelByMonthServlet() {
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		String[] cellTitle = {"基站编号","基站名称", "基站等级", "检测人员","上次检测时间","本次检测时间","上次检测度数","本次检测度数","检测间隔天数","该时间段用电量","平均日用电量","图片名称"};
		 ...
		 for(int i=1;i<=eleclist.size();i++)
		 {
			 ...
			 for (int j = 0; j < cellTitle.length; j++) 
			 {
				...
				case 3:
					...
					break;
				case 4:
					dataCell.setCellValue(e.getLastchecktime());
					break;
				case 5:
