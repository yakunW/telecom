...
<script language="javascript">
	function exportExcel(){
		window.location.href="toExcelBychecker";
	}
</script>
 </head>
<body>
    	...
    	<table class=gridView id="table_<%=(sumitems/10)+1 %>" 
	      ...
	      cellSpacing=0 rules=all border=1>
    		...
    		<tr style="font-weight: bolder">
    			  ...
    			  <TD class=gridViewHeader style="WIDTH: 10%" scope=col>基站名称</TD>
                  <TD class=gridViewHeader style="WIDTH: 10%" scope=col>基站等级</TD>                 
                  <TD class=gridViewHeader style="WIDTH: 15%" scope=col>检测人员</TD>                
                  <TD class=gridViewHeader style="WIDTH: 15%" scope=col>检测时间</TD>
                  <TD class=gridViewHeader style="WIDTH: 20%" scope=col>上次检测度数</TD>
                  <TD class=gridViewHeader style="WIDTH: 20%" scope=col>本次检测度数</TD>
                  <TD class=gridViewHeader style="WIDTH: 15%" scope=col>检测间隔天数</TD>
    			  <TD class=gridViewHeader style="WIDTH: 15%" scope=col>该时间段用电量</TD>
    			  <TD class=gridViewHeader style="WIDTH: 15%" scope=col>平均日用电量</TD>
                  <TD class=gridViewHeader style="WIDTH: 20%" scope=col>图片名称</TD>
    		</tr>
                 <%}
                	sumitems++;
                 %>
