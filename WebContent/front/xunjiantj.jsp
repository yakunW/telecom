...
<div style="position:absolute;left:0px;"> 
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style="color:#419224;font-weight:bolder;font-size:30px;">巡检综合统计查询</font>
</div>
...
PADDING-TOP: 10px; text-align:center;">
		 <form action="xjSearch" method="post" name="xunjian">
		 <table>
		   <tr>
		    <td >
		    ...
		    <td >
		         <table  cellspacing="15">
		            <tr>
		              <td colspan=2 align="left" style="font-weight:bolder;font-size:18;">巡检人员选择：</td>
		            </tr>
		             <% 
		            ...
		            <tr>
		              <td>
		              <select class="inputstyle" style="font-size: 15px;width:150px;"  name="xjName" id="d6">  
    		  ...
    		  <tr> 
    		   ...
    		   <tr >
    				  <td colspan=3 align="center" style="height:80px">
    				    <div>
    					       <input type="image" src="images/btn_search.png" onclick="return checkstation()"/>&nbsp;&nbsp;&nbsp;
	      				       <img src="images/btn_cancel.png" onclick="document.xunjian.reset()">
	      				</div>
    				  </td>
    		  </tr>
    		 </table>
