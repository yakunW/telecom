...
PADDING-TOP: 10px; text-align:center;" class="include">
		...
		<!--  <table border="0" cellspacing="0" align="center">
    	  <tr>
    	  	<td>
    	  		<button type="button" class="button gray" onclick="window.location.href='jtpz_AM.jsp?flag=add'"> 添加配置信息</button>
    	  		<button type="button" class="button gray" onclick="window.location.href='jtpz_MD.jsp?flag=modify'"> 修改配置信息</button>
    	  		<button type="button" class="button gray" onclick="window.location.href='jtpz_MD.jsp?flag=del'"> 删除配置信息</button>
    	  	</td>
    	  </tr>
    	  </table>-->
		  <table border="1" cellspacing="0" align="center" id="resultdata">
    			...
    			for(int i=1;iter.hasNext();i++) {
    	     	...
    	     	<tr>
    	     		<td><%=base.getBaseId()%>
    	     		<input type="hidden" id="baseId" value="<%=base.getBaseId()%>"/>
    	     		</td>
    	     		<td><%=category%></td>
